        ...
        <div className="navbar-end">
          {!user?.uid && (
            <div className="flex justify-center gap-4">
              {/* theme toggler. add functionality later 🛑 */}
              <label className="swap swap-rotate">
                ...
                {/* <!-- sun icon --> */}
                <svg
                  className="swap-off fill-warning w-10 h-10"
                ...
                {/* <!-- moon icon --> */}
                <svg
                  className="swap-on fill-base-300 w-10 h-10"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
              ...
              {/* Buyer or Seller */}
              <select className="select select-primary bg-base-200">
